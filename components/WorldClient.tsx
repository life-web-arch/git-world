    ...
    <div style={{ width: '100vw', height: '100vh', backgroundColor: '#050505', position: 'fixed', inset: 0, overflow: 'hidden' }}>
      ...
      {isDataReady && (
        <>
          ...
          {/* ErrorBoundary prevents the Black Screen of Death */}
          <ErrorBoundary>
            <Canvas shadows camera={{ fov: 45, position:[0, 20, 50] }} style={{ display: 'block', width: '100vw', height: '100vh' }}>
              ...
              <Suspense fallback={null}>
                ...
                <pointLight position={[0, 50, 0]} intensity={1000} color="#4ade80" />
